...
public abstract class AbsListView<T extends BaseAdapter<?>> extends LinearLayout implements IAdapterView<T>
{
	...
	/**
	 * ֪ͨHandlerִ��MSG_COMPUTE_VISIBLECONTENT
	 * */
	...
	/**
	 * ֪ͨHandlerִ��MSG_CHANGE_VERTICALDIVIDER
	 * */
	...
	/**
	 * ֪ͨHandlerִ��MSG_CHANGE_HORIZONTALDIVIDER
	 * */
	...
	/**
	 * ֪ͨHandlerִ��MSG_CHANGE_SELECTOR
	 * */
	...
	/**
	 * ֪ͨHandlerִ��MSG_CHANGE_SELECTION
	 * */
