...
public class ControlCheckTaskActivity extends BaseActivity {
    ...
    public void setCurrentFragment(int currentFragment, TakeStockOrderList.DataBean takeStockOrder, String text, int index) {
        ((SearchCheckTaskListFragment) mFragments.get(2)).orderId = takeStockOrder.getId();
...
//            if (vpCommon.getCurrentItem() == 2) {
//                ((SearchCheckOrderListFragment) mFragments.get(1)).text = text;
//                ((SearchCheckOrderListFragment) mFragments.get(1)).index = index;
//            } else {
//                ((SearchCheckOrderListFragment) mFragments.get(1)).text = null;
//                ((SearchCheckOrderListFragment) mFragments.get(1)).index = 1;
//            }
