...
public final class ActivityProxy
{
    ...
    public interface IActivityExtend
    {
        ...
        void showLoadingIndicator(String message,long showingTime);
        ...
        void showLoadingIndicator(String message, int theme, boolean cancelable, boolean canceledOnTouchOutside,
                                  long showingTime);
    ...
    public void showLoadingIndicatorDialog(final String message, final int theme, final boolean cancelable,
                                           final boolean canceledOnTouchOutside, final long showingTime)
    {
        Activity rootActivity = getRootActivity();
        if (rootActivity != mActivity && rootActivity instanceof IActivityExtend)
        {
            ((IActivityExtend)rootActivity).showLoadingIndicator(message, theme, cancelable, canceledOnTouchOutside,
                    showingTime);
        }
        else
        {
            mActivity.runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    showLoadingIndicatorDialogImpl(message, theme, cancelable, canceledOnTouchOutside, showingTime);
                }
            });
        }
    }
    ...
    private synchronized void showLoadingIndicatorDialogImpl(String message, int theme, boolean cancelable,
                                                             boolean canceledOnTouchOutside, long showingTime)
    {
        LogUtil.v(TAG, "showLoadingIndicatorDialog: " + message);
        try
        {
