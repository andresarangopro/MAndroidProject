...
/**
 * Entity mapped to table "TAKE_STOCK_ORDER".
 */
@Entity(active = true)
public class TakeStockOrder {
    ...
    @Generated
    private transient TakeStockOrderDao myDao;
    ...
    public TakeStockOrder(Long id) {
        this.id = id;
    }

    @Generated
    public TakeStockOrder(Long id, String code, String takeStockId, String warehouseName) {
        this.id = id;
        this.code = code;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getTakeStockOrderDao() : null;
    }
    ...
    public List<TakeStockTask> getTasks() {
        if (tasks == null) {
            ...
            List<TakeStockTask> tasksNew = targetDao._queryTakeStockOrder_Tasks(id);
            synchronized (this) {
                if(tasks == null) {
                    tasks = tasksNew;
                }
