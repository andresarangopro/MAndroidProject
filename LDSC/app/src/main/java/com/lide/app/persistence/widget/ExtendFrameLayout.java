package com.lide.app.persistence.widget;
...
import static com.lide.app.persistence.widget.ViewObservable.*;

public class ExtendFrameLayout extends FrameLayout implements IViewObservable, Checkable
{
