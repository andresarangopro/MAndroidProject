...
public class QueryModelImpl implements IQueryModel {
    ...
    /**
     * 分页模糊查询仓库，根据模糊字段查询相似的仓库号，对调返回的是仓库列表
     * @param code 模糊字段
     * @param listener
     * @throws Exception
     */
    ...
    /**
     * 分页模糊查询入库单，根据模糊字段查询相似的入库单，返回的是入库单列表
     * @param order
     * @param currentOderListPage
     * @param listener
     * @throws Exception
     */
     ...
     * 根据多条码获取商品条码详细信息档案列表
     *
     * @param multiBarcode 多条码
     */
    public void findParticularByMultiBarcode(String multiBarcode, final OnLoadFinishListener listener) {

        String apiMethod = "api/sku/find-particular-by-multi-barcode/" + multiBarcode;
        String postUrl = Utils.apiUrl + apiMethod;
