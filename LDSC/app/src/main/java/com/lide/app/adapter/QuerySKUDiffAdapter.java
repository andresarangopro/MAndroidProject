 ...
 */
public class QuerySKUDiffAdapter extends BaseListAdapter<SkuDiff.DataBean> {

    public QuerySKUDiffAdapter(Context context, List<SkuDiff.DataBean> list) {
        super(context, list);
    }
    ...
    public View bindView(int position, View convertView, ViewGroup parent) {
        ...
        SkuDiff.DataBean bean = getList().get(position);
