...
public class KillTagFragment extends FragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_kill_tag, container, false);
    }
        ...
        public void onClick(View v) {
            ...
            if (CkWithUii_Write.isChecked())// 指定标签
            {
                ...
                if (TextUtils.isEmpty(strUII)) {
                    ShowToast(R.string.uhf_msg_tag_must_not_null);
                    return;
                }
